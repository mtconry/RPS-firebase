...
//                 //playerturn = 0
//                 playerTurn = 0; 
//                 // update player 2 database value
//                 database.ref().update({
//                     db_p2Choice: decision,
//                     db_playerTurn: playerTurn

//                 });
//                 //player2Rock will be immediately overwrittenl to avoid writing in the wrong order, this line isn't needed
//                 $(".player2Paper").text (" ");
// 			    $(".player2Scissors").text (" ");
//             }
...
//             );   
//     }
//     //Shows the player which seat they are in, or if they are spectating
//     function drawPlayerNameDisplay() {
//         if(whoAmI === "none") {
//             $("#playerIntro").html("You are currently spectating.");
...
//     // When the user closes the window or the tab, their seat becomes available
//     $(window).unload(function(){
//         // If the player is p1, reset the p1 database values
//         if(whoAmI === "player1"){
//             database.ref().update({
//                 db_p1Name: null, 
//                 db_p1Wins: 0,
